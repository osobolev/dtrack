...
public final class DaoTester {
    ...
    public static void testDaos(List<Class<? extends BaseDao>> classes) throws Throwable {
        ...
        try (Connection connection = DriverManager.getConnection("jdbc:postgresql://localhost:5431/", "dtrack", "dtrack")) {
